...
import com.taba.tastevin.databinding.FragmentDetailBinding
import com.taba.tastevin.domain.Wine

class DetailFragment : Fragment() {

    private lateinit var binding: FragmentDetailBinding
    private val dataset = com.taba.tastevin.data.ListData.newBoard
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 북마크 버튼 초기화
        val bookmarkDB: com.taba.tastevin.database.WineDao =
            (activity?.application as com.taba.tastevin.TastevinApplication).database.wineDao()
